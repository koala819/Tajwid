...
export const criteres = [
  ...
  { id: 'lahn', label: 'الاحتراز من اللحن الجلي', labelFr: 'Éviter les erreurs évidentes', max: 10 },
  { id: 'tafkhim', label: 'تطبيق أحكام التفخيم والترقيق', labelFr: 'Emphatisation/Atténuation', max: 10 },
  { id: 'huruf', label: 'النطق الصحيح للحروف، مراعاة المخارج والصفات', labelFr: 'Prononciation correcte des lettres', max: 10 },
