...
export const translations = {
  fr: {
    ...
    qualifiedYes: 'Oui',
    qualifiedNo: 'Non',
    winnerToggleLabel: 'Gagnant',
    winnerYes: 'Lauréat',
    winnerNo: 'Retirer lauréat',
    winnerBadge: 'Gagnant',
    seePublicPage: 'Voir la page publique',
    
    // Page résultats
    resultsTitle: 'Résultats de la demi-finale',
    resultsDemiFinaleSubtitle: 'Résultats présentés par niveau.',
    resultsFinaleTitle: 'Résultats de la finale',
    resultsFinaleSubtitle: 'Résultats présentés par niveau.',
    resultsQualifTitle: 'Résultats de qualification',
    resultsQualifSubtitle: 'Résultats présentés par niveau.',
  ...
  ar: {
    ...
    qualifiedYes: 'نعم',
    qualifiedNo: 'لا',
    winnerToggleLabel: 'فائز',
    winnerYes: 'فائز',
    winnerNo: 'إلغاء الفوز',
    winnerBadge: 'فائز',
    seePublicPage: 'عرض الصفحة العامة',
    
    // Page résultats
    resultsTitle: 'نتائج نصف النهائي',
    resultsDemiFinaleSubtitle: 'النتائج معروضة حسب المستوى.',
    resultsFinaleTitle: 'نتائج النهائي',
    resultsFinaleSubtitle: 'النتائج معروضة حسب المستوى.',
    resultsQualifTitle: 'نتائج التصفيات',
    resultsQualifSubtitle: 'النتائج معروضة حسب المستوى.',
